...
- Axis Functions – Learn how to set axis labels, limits, and ticks.

- Bar Plot – Create simple and grouped bar charts.
...
- Save Figure – Export plots to image files (PNG, JPG, etc.).
